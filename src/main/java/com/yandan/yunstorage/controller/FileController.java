...
//        }
    ...
    public ResponseEntity<InputStreamResource> download(HttpServletRequest request, @RequestParam("path") String path,
                                                        @RequestParam(value = "user") String user,
...
//普通文件下载
    ...
    public ResponseEntity<InputStreamResource> downloadShare(HttpServletRequest request, @RequestParam("path") String path, @RequestParam("user") String user
    )
            throws Exception {
...
//       }
    ...
    public ResultVO online(HttpServletRequest request, @RequestParam("path") String path,
        ...
        path=path.contains(myConfigure.getHdfsUrl())? path:myConfigure.getHdfsUrl()+path;
